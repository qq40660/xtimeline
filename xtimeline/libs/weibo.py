...
APP_KEY = '3231340587s'
APP_SECRET = '702b4bcc6d56961f569943ecee1a76f4'
CALLBACK_URL = ''
...
class APIClient(object):
    ...
    '''
    def __init__(self, app_key=APP_KEY, app_secret=APP_SECRET, redirect_uri=CALLBACK_URL, response_type='code', domain='api.weibo.com', version='2'):
